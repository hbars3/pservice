...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="fondo">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark navegacion">
            <a href="#" class="navbar-brand text-white navegacion_titulo">Service Provider</a>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center ">
                <div class="col imagen animate__animated animate__pulse">
                    <img src="service_provider_logo.png" alt="Responsive image" class="logo_service_provider">
                </div>
            </div>
            <!-- Fondo-->
            <div class="row justify-content-center">
